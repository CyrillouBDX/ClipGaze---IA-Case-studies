...
def get_args_parser_test():
    ...
    parser.add_argument('--img_ftrs_dir', default='mon_dataset/featuremaps/',
                        type=str, help="Directory of precomputed target present CLIP visual features")
    parser.add_argument('--img_ftrs_dir_absent', default='mon_dataset/featuremaps',
                        type=str, help="Directory of precomputed target absent CLIP visual features")
    parser.add_argument("--embedding_dir", default="./output/enbeddings_a_photo_of.npy",
    ...
    parser.add_argument('--num_decoder', default=0, type=int, help="Number of transformer decoder layers")
    ...
    parser.add_argument('--task', default='Duck', type=str, help="if evaluation is in ZeroGaze setting, the unseen target to evaluate the model")
